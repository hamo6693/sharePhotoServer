...
router.get("/profile", isLoggedIn, controller.getNameUser);

router.get("/get-profile", isLoggedIn, controller.getProfile);

router.put("/update-profile", isLoggedIn, controller.updateProfile);
